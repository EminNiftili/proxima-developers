        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h3 className="h3 mb-4" data-aos="fade-up">
              Proxima developers nədir?
            </h3>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              Proxima developers azərbaycan informasiya texnologiyaları üzrə təlim və tədrisini həyata keçirən qurumdur.
            </p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                <a className="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0" href="#joinUsform">
                  Bizə qoşul
                </a>
              </div>
